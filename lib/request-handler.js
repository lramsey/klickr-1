...
exports.handleKeystrokes = function (req, res) {
  ...
  // console.log("The keystroke object is: ", keystroke);
  //console.log("The keystroke object is - parsed: ", JSON.parse(keystroke));

  // // Justin will need to send this as an object to me
  // // The object will look like this for now:
  // // { 'character' : 'a',
  // //   'count'     : 5 }

  // once data is received, need to post to mongo db
  // Keystroke.create(JSON.parse(keystroke), function(err, obj){
  Keystroke.create({character: "a", count: 5}, function(err, obj){
    if(!!err){
  ...
  // var dbData = new Keystroke(JSON.parse(keystroke));
  
  // dbData.save(function (err) {
  //   if (err) {
  //     console.log('Reached handler for Keystroke');
  //     throw err;
  //   }
